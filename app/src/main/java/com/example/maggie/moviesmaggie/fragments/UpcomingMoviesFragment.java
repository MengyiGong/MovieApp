...
public class UpcomingMoviesFragment extends LoadingFragment implements UpcomingMoviesPresenter.View,
    ...
    public void onRefresh() {
        ...
        if (!isLoad) {
            ...
            upcomingMoviesPresenter.loadData(1);
            isLoad = true;
        } else {
    ...
    public void onRetry() {
        int num = page;
        upcomingMoviesPresenter.loadData(num);
        isLoad = true;
    }
    ...
    public void onDestroyView() {
        ...
        upcomingMoviesPresenter.detachView();
        super.onDestroyView();
    }
    ...
    public void showMessage(String message) {
        hideProgress();
        loadMoreWrapper.showLoadError();
        Log.e("UpcomingMoviesFragment", message);
