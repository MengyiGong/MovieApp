...
public class LoadMoreWrapper<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ViewHolder getLoadMoreViewHolder(ViewGroup parent) {
        if (mLoadMoreView == null) {
            mLoadMoreView = LayoutInflater.from(mContext).inflate(R.layout.fragment_loading, parent, false);
        }
    ...
    private ViewHolder getLoadFailedViewHolder() {
        if (mLoadMoreFailedView == null) {
            ...
            ((TextView) mLoadMoreFailedView).setText("Load Failed. Please Try Again");
    ...
    private ViewHolder getNoMoreViewHolder() {
        if (mNoMoreView == null) {
            ...
            ((TextView) mNoMoreView).setText("No More Data");
